                ...
                <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
                  <img
                    ...
                    style={{
                      ...
                      transform: `scale(${slot.scale ?? 1}) translate(${(slot.offsetX ?? 50) - 50}%, ${(slot.offsetY ?? 50) - 50}%) translate(${-(tileCol / tileCols) * 100}%, ${-(tileRow / tileRows) * 100}%)`,
      ...
      >
        <img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "contain",
            transform: `scale(${positioning.scale}) translate(${positioning.offsetX}%, ${positioning.offsetY}%)`,
            transformOrigin: "center center",
            pointerEvents: "none",
          }}
        />
