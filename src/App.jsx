              ...
              <>
                <img
                  ...
                  style={{
                    ...
                    display: "block",
                    objectFit: "cover",
                    objectPosition: `${slot.offsetX ?? 50}% ${slot.offsetY ?? 50}%`,
                    transform: slot.scale && slot.scale !== 1 ? `scale(${slot.scale})` : undefined,
...
export default function App() {
  ...
  function openPositionEditor(pageIdxGlobal, sIdx) {
    ...
    setPositioning({
      pageIdxGlobal,
      slotIdx: sIdx,
      offsetX: slot.offsetX ?? 50,
      offsetY: slot.offsetY ?? 50,
      scale: slot.scale ?? 1,
      image: slot.image,
  ...
  function updatePositioningOffset(dx, dy) {
    setPositioning((prev) => {
      ...
      return {
        ...prev,
        offsetX: Math.max(0, Math.min(100, prev.offsetX + dx)),
        offsetY: Math.max(0, Math.min(100, prev.offsetY + dy)),
      };
    });
  }
  ...
  function savePositioning() {
    ...
    setBinders((prev) => {
      ...
      if (slot) next[binderIndex].pages[pageIdxGlobal].slots[slotIdx] = { ...slot, offsetX, offsetY, scale };
      return next;
    });
    setPositioning(null);
  }
      ...
      >
        <img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            objectPosition: `${positioning.offsetX}% ${positioning.offsetY}%`,
            transform: `scale(${positioning.scale})`,
            transformOrigin: "center center",
            pointerEvents: "none",
          }}
        />
